...
let x = `<span class="close">&times;</span>`// carpi isareti
//eleman ekleme
...
if(inputDOM.value.length>0 ){
   ...
   inputDOM.value = "" // inputa girilen deger temizlenir
   // carpiya basildiginda liste elamanini kaldirmak 
$('li').hover(function(){
...
// eski elemanlara check class eklemek 
